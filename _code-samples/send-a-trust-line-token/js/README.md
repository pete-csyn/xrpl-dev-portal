# Send a Trust Line Token Examples (JavaScript)
...
The main script auto-invokes `setup.js` if `setup.json` is not present. It creates a trust line from the holder, sends 500 FOO from issuer to holder, and prints the holder's trust lines and the issuer's outstanding obligations.
